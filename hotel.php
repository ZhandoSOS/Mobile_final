...
?>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
      ...
      if(isset($_POST['search'])){
				...
				$limit = $_POST['maxPrice'];
				$maxPrice = (int)$limit;
                $sql = "SELECT * FROM resting_place WHERE (country LIKE '%$country%'  and  price < $maxPrice ) and rest_place_id <> 0 ORDER BY price ASC";
                  ...
                  <p> Features: " .  $features ."</p><h5>  " . $country." </h5><p> " .  $sea_name ."</p>
                              <div class='star d-flex clearfix'>
                                <div class='mr-auto float-left'>
								  ...
								  <p class='nav-item cta'><a href='http://localhost/traveland/order.php?op= ". $row['rest_place_id'] ."'" . "class='nav-link'>Book Now</a></p>
				...
				echo "<h4 class='price'>No result</h4>";
			}
